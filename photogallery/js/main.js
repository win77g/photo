...
(function($) {
    ...
    hero_s.owlCarousel({
        ...
        animateOut: 'fadeOut',
    	animateIn: 'fadeIn',
        navText: ['<img src="/photogallery/img/angle-left-w.png" alt="">', '<img src="/photogallery/img/angle-rignt.png" alt="">'],
        smartSpeed: 1200,
        autoHeight: false,
	...
	$('.gallery-single-slider').owlCarousel({
        ...
        items: 1,
        dots: false,
        navText: ['<img src="/photogallery/img/angle-left.png" alt="">', '<img src="/photogallery/img/angle-rignt-w.png" alt="">'],
	});
